...
Customer self-registration is closed. Administrators and managers create customer companies from Settings → Customers. That sends a Resend invitation so the contact chooses their own password. Portal logins are never generated by an administrator.
