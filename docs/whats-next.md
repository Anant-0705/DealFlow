...
2. Send quote links by email, approval nudges through Slack, and invoice reminders through WhatsApp, while preserving in-app audit records.
3. Reconcile Razorpay test payments to invoices through idempotent, signature-verified webhooks.
4. Add server-rendered PDFs for quotations and invoices; the current release honestly uses browser print-to-PDF.
